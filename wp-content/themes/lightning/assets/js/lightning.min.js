  ...
  !(function (e) {
    ...
    (function (e, t) {
      ...
      e.addEventListener('scroll', function () {
        t.body.classList.contains('sidebar-fix') &&
          (t.getElementsByClassName('sideSection').length < 1 || o());
      }),
        e.addEventListener('resize', function () {
          t.body.classList.contains('sidebar-fix') &&
            (t.getElementsByClassName('sideSection').length < 1 || o());
    ...
    (function (e, t) {
      e.addEventListener('load', function () {
        (i = t.getElementsByClassName('vk-prlx')).length < 1 ||
          (Array.prototype.forEach.call(i, function (e) {
            var t = e.style.backgroundImage.replace(n, '$1');
            if ('none' != t) {
              var i = new Image();
              (i.src = t),
                e.setAttribute('image_rate', i.width / i.height),
                e.setAttribute('image_w', i.width),
                e.setAttribute('image_h', i.height);
            }
          }),
    ...
    (() => {
      !(function (e, t) {
        ...
        !(function (e, t, i) {
          function a(e) {
            t
              .getElementById('vk-mobile-nav-menu-btn')
              .classList.remove('menu-open'),
              t
                .getElementById('vk-mobile-nav')
                .classList.remove('vk-mobile-nav-open');
          }
          e.addEventListener('DOMContentLoaded', function () {
            var e;
            (e = t.getElementById('vk-mobile-nav-menu-btn')).addEventListener(
              'click',
              function () {
                e.classList.contains('menu-open')
                  ? a()
                  : (o('.vk-mobile-nav-menu-btn', 'menu-open'),
                    t
                      .getElementById('vk-mobile-nav')
                      .classList.add('vk-mobile-nav-open'));
              }
            ),
          ...
          (function (a) {
            ...
            function l(e) {
              var t = e.target,
                n = t.parentNode,
                i = t.nextSibling;
              t.classList.contains('acc-btn-open')
